...
export const metadata = {
  title: "Digital Marketing Agency Mount Eliza | Seam Media",
  description: "Professional digital marketing services in Mount Eliza. We offer social media management, web design, SEO, Google Ads, and more to help your business grow.",
};

export default function MountElizaPage() {
  const services = [
    { href: "/mount-eliza/social-media", label: "Social Media Management", description: "Grow your online presence with strategic social media campaigns tailored for Mount Eliza businesses." },
    { href: "/mount-eliza/web-design", label: "Website Design", description: "Custom, responsive websites designed to convert visitors into customers." },
    { href: "/mount-eliza/seo", label: "SEO", description: "Rank higher in search results and attract more local Mount Eliza customers." },
    { href: "/mount-eliza/graphic-design", label: "Graphic Design", description: "Professional design services for all your branding and marketing materials." },
      ...
      <Section background="white">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed mb-8">
            Seam Media provides comprehensive digital marketing services to businesses in Mount Eliza and surrounding areas.
