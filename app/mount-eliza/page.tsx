...
export default function MountElizaPage() {
  const services = [
    { href: "/social-media", label: "Social Media Management", description: "Grow your online presence with strategic social media campaigns tailored for Mount Eliza businesses." },
    { href: "/web-design", label: "Website Design", description: "Custom, responsive websites designed to convert visitors into customers." },
    { href: "/seo", label: "SEO", description: "Rank higher in search results and attract more local Mount Eliza customers." },
