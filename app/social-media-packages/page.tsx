...
import { ArrowRight, Instagram, Users, BarChart3, Calendar, Search, Target, Zap, Rocket, ArrowUpRight, Send, Check } from "lucide-react";
    ...
    <section className="pt-40 pb-24 px-6 min-h-[80vh] flex flex-col justify-center bg-[#09090b] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        <p className="text-lg md:text-xl text-zinc-400 max-w-2xl leading-relaxed mb-12">
          Choose the perfect package to grow your social media presence. From content creation to full management, we've got you covered.
        </p>
