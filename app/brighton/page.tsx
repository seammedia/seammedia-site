...
export const metadata = {
  title: "Digital Marketing Agency Brighton | Seam Media",
  description: "Professional digital marketing services in Brighton. We offer social media management, web design, SEO, Google Ads, and more to help your business grow.",
};

export default function BrightonPage() {
  const services = [
    { href: "/social-media", label: "Social Media Management", description: "Grow your online presence with strategic social media campaigns tailored for Brighton businesses." },
    { href: "/web-design", label: "Website Design", description: "Custom, responsive websites designed to convert visitors into customers." },
    { href: "/seo", label: "SEO", description: "Rank higher in search results and attract more local Brighton customers." },
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-8">
            ...
            <span className="relative inline-block px-4">
              <span className="relative z-10 text-white">Brighton</span>
              <span
          ...
          <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed mb-8">
            Seam Media provides comprehensive digital marketing services to businesses in Brighton and surrounding areas.
      ...
      <Section background="white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="w-full aspect-[4/3] lg:aspect-[16/9] rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d25183.670792500536!2d144.95543213976222!3d-37.908024540263945!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad6692281478c97%3A0x5045675218cdd40!2sBrighton%20VIC%203186!5e0!3m2!1sen!2sau!4v1763507847016!5m2!1sen!2sau"
              width="100%"
              height="100%"
              style={{ border: 0 }}
