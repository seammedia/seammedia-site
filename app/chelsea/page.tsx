...
export const metadata = {
  title: "Digital Marketing Agency Chelsea | Seam Media",
  description: "Professional digital marketing services in Chelsea. We offer social media management, web design, SEO, Google Ads, and more to help your business grow.",
};

export default function ChelseaPage() {
  const services = [
    { href: "/social-media", label: "Social Media Management", description: "Grow your online presence with strategic social media campaigns tailored for Chelsea businesses." },
    { href: "/web-design", label: "Website Design", description: "Custom, responsive websites designed to convert visitors into customers." },
    { href: "/seo", label: "SEO", description: "Rank higher in search results and attract more local Chelsea customers." },
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-8">
            ...
            <span className="relative inline-block px-4">
              <span className="relative z-10 text-white">Chelsea</span>
              <span
          ...
          <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed mb-8">
            Seam Media provides comprehensive digital marketing services to businesses in Chelsea and surrounding areas.
      ...
      <Section background="white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="w-full aspect-[4/3] lg:aspect-[16/9] rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12567.560328556354!2d145.1112942115873!3d-38.04964744880127!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad672a7ee65f51b%3A0x5045675218ce120!2sChelsea%20VIC%203196!5e0!3m2!1sen!2sau!4v1763507864339!5m2!1sen!2sau"
              width="100%"
              height="100%"
              style={{ border: 0 }}
