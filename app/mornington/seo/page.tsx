...
export const metadata = {
  title: "SEO Services Mornington | Seam Media",
  description: "Professional SEO services in Mornington. Improve your local search rankings, attract more customers, and grow your business with our proven SEO strategies.",
};

export default function MorningtonSEOPage() {
  return (
    <>
      {/* Hero Section */}
      <Section background="white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed mb-8">
            Rank higher in Google search results and attract more local customers in Mornington with our comprehensive SEO services.
          </p>
        </div>
      </Section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 leading-relaxed">
                Dominate local search results in Mornington. We optimize your Google Business Profile, build local citations, and ensure your business appears when locals search for your services.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 leading-relaxed">
                Target the right keywords to attract qualified traffic. We identify high-value search terms that your Mornington customers are actually using.
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                We've helped countless Mornington businesses improve their search rankings and drive more organic traffic. Our SEO strategies deliver measurable, long-term results.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Understanding the Mornington market is key to SEO success. We know the local competitors, search trends, and what it takes to rank for location-specific keywords.
              </p>
            </div>
