...
export const metadata = {
  title: "Website Design Mornington | Seam Media",
  description: "Professional website design services in Mornington. We create custom, responsive websites that convert visitors into customers and grow your business.",
};

export default function MorningtonWebDesignPage() {
  return (
    <>
      {/* Hero Section */}
      <Section background="white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed mb-8">
            Transform your online presence with a professionally designed website that attracts customers and drives results for your Mornington business.
          </p>
        </div>
      </Section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 leading-relaxed">
                Built for search engines from the ground up. Your new website will be structured and coded to help you rank higher in Google search results for Mornington-area searches.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                As a Mornington-based agency, we understand local businesses and their unique needs. We create websites that resonate with your target audience in the area.
              </p>
            </div>
