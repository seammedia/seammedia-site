...
export const metadata = {
  title: "Social Media Management Mornington | Seam Media",
  description: "Expert social media management services in Mornington. We help local businesses grow their online presence with strategic social media campaigns across all platforms.",
};

export default function MorningtonSocialMediaPage() {
  return (
    <>
      {/* Hero Section */}
      <Section background="white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed mb-8">
            Grow your Mornington business with strategic social media management that drives engagement, builds community, and generates real results.
          </p>
        </div>
      </Section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 leading-relaxed">
                Build meaningful relationships with your audience. We monitor, respond to comments and messages, and foster an engaged community around your Mornington business.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 leading-relaxed">
                Data-driven social media strategies designed specifically for Mornington businesses. We plan content calendars, identify optimal posting times, and track performance metrics.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 leading-relaxed">
                Maximize your reach with targeted social media advertising. We create and manage campaigns on Facebook, Instagram, and LinkedIn to reach your ideal customers in Mornington.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                We understand the Mornington market and create content that resonates with your local audience. Our team knows what works for businesses in the area.
              </p>
            </div>
