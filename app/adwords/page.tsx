...
import { ArrowRight, Search, MousePointerClick, BarChart3, RefreshCw, Target, Zap, TrendingUp, Rocket, ArrowUpRight, Send } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        <h1 className="text-6xl md:text-8xl font-bold leading-[0.95] tracking-tight mb-8 max-w-5xl group">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400">
            <ScrambleText text="Google Ads" />
          </span>
          <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-500 to-zinc-700">
            <ScrambleText text="That Drive" />
          </span>
          <br />
          <span className="inline-block">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400 group-hover:from-cyan-500 group-hover:to-cyan-600 transition-all duration-300">
        ...
        <p className="text-lg md:text-xl text-zinc-400 max-w-2xl leading-relaxed mb-12">
          Drive qualified traffic to your website with expertly managed Google Ads campaigns. We maximise your ROI through data-driven strategies and continuous optimisation.
        </p>
  ...
  const offerItems = [
    {
      ...
      description: "Appear at the top of Google search results when potential customers are actively searching for your products or services.",
      tags: ["Keywords", "Bidding", "Rankings"],
      icon: <Search className="text-zinc-400" size={28} />
    },
    {
      title: "Display Advertising",
      description: "Reach your audience across millions of websites with visually engaging display ads that drive brand awareness and conversions.",
      tags: ["Banners", "Reach", "Awareness"],
      icon: <MousePointerClick className="text-zinc-400" size={28} />
    },
    {
      title: "Remarketing",
      description: "Re-engage visitors who didn't convert, keeping your brand top-of-mind and bringing them back to complete their purchase.",
      tags: ["Retargeting", "Conversions", "ROI"],
      icon: <RefreshCw className="text-zinc-400" size={28} />
    },
    {
      title: "Shopping Campaigns",
      description: "Showcase your products directly in Google search results with product images, prices, and business information.",
      tags: ["E-commerce", "Products", "Sales"],
        ...
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            ...
            <span className="relative inline-flex ml-2 align-middle">
              <span className="animate-ping absolute inline-flex h-3 w-3 rounded-sm bg-cyan-400 opacity-75"></span>
              <span className="relative inline-flex h-3 w-3 rounded-sm bg-cyan-500"></span>
            </span>
          </h2>
          <p className="text-zinc-500 text-lg max-w-2xl">
            Comprehensive Google Ads management to drive qualified traffic and maximise your return on investment.
          </p>
        </div>
  ...
  const steps = [
    {
      id: 1,
      title: "Research",
      description: "Deep dive into your market, competitors, and target audience. Identifying high-value keywords and opportunities.",
      icon: <Search className="text-blue-400" size={24} />,
    },
    {
      id: 2,
      title: "Strategy",
      description: "Building custom campaign structures, ad groups, and targeting strategies aligned with your business goals.",
      icon: <Target className="text-yellow-400" size={24} />,
    },
    {
      id: 3,
      title: "Launch",
      description: "Creating compelling ad copy and launching campaigns. Setting up conversion tracking and analytics.",
      icon: <Zap className="text-cyan-400" size={24} />,
    },
    {
      id: 4,
      title: "Optimise",
      description: "Continuous monitoring and optimisation. A/B testing, bid adjustments, and performance improvements.",
    ...
    <section className="py-24 px-6 bg-[#09090b]" ref={containerRef}>
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-20">
          ...
          <div className="text-xs font-mono text-zinc-600 animate-pulse">CONVERTING...</div>
        </div>

        <p className="text-zinc-400 mb-16 text-center max-w-lg mx-auto">
          From research to results. A data-driven approach to Google Ads success.
        </p>
        ...
        <div className="relative">
          ...
          <div
            className="absolute left-1/2 top-0 w-px bg-cyan-500 transform -translate-x-1/2 hidden md:block transition-all duration-[2000ms] ease-linear shadow-[0_0_10px_rgba(6,182,212,0.5)]"
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex items-center justify-center w-8 h-8 order-2">
                  <div className={`w-4 h-4 rounded-full bg-zinc-800 border border-zinc-700 transition-all duration-500 ${visibleSteps.includes(step.id) ? 'bg-cyan-500 border-cyan-400 shadow-[0_0_15px_rgba(6,182,212,1)] scale-125' : ''}`}></div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[500px]">
          ...
          >
            ...
            <div className="relative flex-1 flex items-center">
              ...
              >
                <div className="mb-6">
                  <span className="inline-block p-3 rounded-2xl bg-zinc-800/50 text-cyan-400 mb-6">
            ...
            <div className="relative z-10 pt-6 border-t border-zinc-800/50 flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center text-lg font-bold text-white">
          ...
          <div className="lg:col-span-5 h-[300px] lg:h-full bg-zinc-950 rounded-[2.5rem] border border-zinc-800 p-8 md:p-12 flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute -top-24 -right-24 w-64 h-64 bg-cyan-600/10 rounded-full blur-[80px] group-hover:bg-cyan-600/20 transition-all duration-700" />

            <div className="relative z-10">
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-7xl md:text-8xl font-bold tracking-tighter text-white">5.0</span>
                <span className="text-4xl md:text-5xl font-bold text-cyan-500">/5</span>
              </div>

              <div className="space-y-4">
                <div className="h-12 w-1 bg-cyan-500 rounded-full mb-6" />
                ...
                <p className="text-zinc-500 leading-relaxed">
                  "We pride ourselves on results. From campaign setup to ongoing optimisation, our clients trust us to deliver ROI-focused advertising."
                </p>
              </div>
    ...
    <section className="py-40 px-6 bg-black relative overflow-hidden flex items-center justify-center">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center gap-2 mb-12 bg-zinc-900/80 border border-zinc-800 px-4 py-1 rounded-full">
            ...
            <span className="text-cyan-500 font-mono text-xs tracking-widest">ADS READY</span>
        </div>
        ...
        <div className="relative mb-12 group cursor-default">
            <h2 className="text-7xl md:text-9xl font-black text-white tracking-tighter uppercase relative z-10">
                Ready To<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-800">Convert?</span>
            </h2>
        </div>

        <p className="text-zinc-400 text-xl mb-4">Stop wasting ad spend. Start converting clicks into customers.</p>
        <p className="text-zinc-500 mb-12">Data-driven campaigns that deliver real ROI.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    name="firstName"
                    required
                    className="w-full bg-zinc-900/30 border border-white/10 rounded-lg px-4 py-3 text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all hover:border-white/20"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <select
                  id="service"
                  name="service"
                  className="w-full bg-zinc-900/30 border border-white/10 rounded-lg px-4 py-3 text-zinc-100 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all hover:border-white/20"
                >
                  <option value="">Select a service</option>
                  <option value="Search Advertising">Search Advertising</option>
                  <option value="Display Advertising">Display Advertising</option>
                  <option value="Remarketing">Remarketing</option>
                  <option value="Shopping Campaigns">Shopping Campaigns</option>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  name="message"
                  rows={4}
                  placeholder="What are your advertising goals and current challenges?"
                  className="w-full bg-zinc-900/30 border border-white/10 rounded-lg px-4 py-3 text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all hover:border-white/20 resize-y min-h-[120px]"
                />
              </div>
              ...
              {/* Success Message */}
              {status === "success" && (
                <div className="bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 px-4 py-3 rounded-lg">
