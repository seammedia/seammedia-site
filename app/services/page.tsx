...
export const metadata: Metadata = {
  title: "Services | Seam Media",
  description:
    "Comprehensive digital marketing services including social media management, SEO, web design, branding, Google Ads, photography, and videography.",
};
