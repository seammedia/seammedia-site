...
import { ArrowRight, Palette, PenTool, Image, Layers, Search, Lightbulb, Brush, Rocket, ArrowUpRight, Send } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <h1 className="text-6xl md:text-8xl font-bold leading-[0.95] tracking-tight mb-8 max-w-5xl group">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400">
            <ScrambleText text="Crafting Visual" />
          </span>
          <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-500 to-zinc-700">
            <ScrambleText text="Identities That" />
          </span>
          <br />
          <span className="inline-block">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400">
              <ScrambleText text="Stand " />
            </span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400 group-hover:from-purple-500 group-hover:to-purple-600 transition-all duration-300">
              <ScrambleText text="Out" />
            </span>
          </span>
        </h1>

        <p className="text-lg md:text-xl text-zinc-400 max-w-2xl leading-relaxed mb-12">
          We create stunning graphic designs that capture your brand essence. From logos to marketing materials, our designs make lasting impressions.
        </p>
...
const WhatWeDesign = () => {
  const designItems = [
    {
      title: "Logo Design",
      description: "Memorable brand marks that capture your essence. Custom logos designed to work across all platforms and scales.",
      tags: ["Branding", "Identity", "Vector"],
      icon: <Palette className="text-zinc-400" size={28} />
    },
    {
      title: "Marketing Materials",
      description: "Business cards, brochures, flyers, and posters designed to captivate your audience and drive action.",
      tags: ["Print", "Digital", "Design"],
      icon: <Layers className="text-zinc-400" size={28} />
    },
    {
      title: "Digital Graphics",
      description: "Social media graphics, email templates, web banners, and digital ads optimized for online platforms.",
      tags: ["Social", "Web", "Ads"],
      icon: <Image className="text-zinc-400" size={28} />
    },
    {
      title: "Brand Identity",
      description: "Complete visual identity systems including color palettes, typography, and brand guidelines.",
      tags: ["System", "Guidelines", "Strategy"],
      icon: <PenTool className="text-zinc-400" size={28} />
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-500">What We Design</span>
            <span className="relative inline-flex ml-2 align-middle">
              <span className="animate-ping absolute inline-flex h-3 w-3 rounded-sm bg-purple-400 opacity-75"></span>
              <span className="relative inline-flex h-3 w-3 rounded-sm bg-purple-500"></span>
            </span>
          </h2>
          <p className="text-zinc-500 text-lg max-w-2xl">
            Visual solutions crafted with precision and purpose for brands that demand excellence.
          </p>
        </div>
          ...
          {designItems.map((item, index) => (
            ...
            >
              ...
              <div className="border-t border-white/5 pt-6 flex justify-between items-center">
                  ...
                  <span className="text-white font-bold text-sm">100% Custom</span>
              </div>
            </div>
          ))}
        </div>
  ...
  const steps = [
    {
      id: 1,
      title: "Discovery",
      description: "Understanding your brand, audience, and design goals. We dive deep into what makes you unique.",
      icon: <Search className="text-blue-400" size={24} />,
    },
    {
      id: 2,
      title: "Concept",
      description: "Exploring multiple creative directions. Sketches, mood boards, and initial concepts to find the perfect vision.",
      icon: <Lightbulb className="text-yellow-400" size={24} />,
    },
    {
      id: 3,
      title: "Refinement",
      description: "Perfecting every detail based on your feedback. We iterate until it's exactly right.",
      icon: <Brush className="text-purple-400" size={24} />,
    },
    {
      id: 4,
      title: "Delivery",
      description: "Final files in all formats you need. Print-ready, web-optimized, and everything in between.",
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-20">
          <h2 className="text-4xl font-bold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-500">Our Process</span>
            <span className="relative inline-flex ml-2 align-middle">
              <span className="animate-ping absolute inline-flex h-3 w-3 rounded-sm bg-purple-400 opacity-75"></span>
              <span className="relative inline-flex h-3 w-3 rounded-sm bg-purple-500"></span>
            </span>
          </h2>
          <div className="text-xs font-mono text-zinc-600 animate-pulse">CREATING...</div>
        </div>

        <p className="text-zinc-400 mb-16 text-center max-w-lg mx-auto">
          From initial concept to final delivery. A collaborative approach to exceptional design.
        </p>
        ...
        <div className="relative">
          ...
          <div
            className="absolute left-1/2 top-0 w-px bg-purple-500 transform -translate-x-1/2 hidden md:block transition-all duration-[2000ms] ease-linear shadow-[0_0_10px_rgba(168,85,247,0.5)]"
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex items-center justify-center w-8 h-8 order-2">
                  <div className={`w-4 h-4 rounded-full bg-zinc-800 border border-zinc-700 transition-all duration-500 ${visibleSteps.includes(step.id) ? 'bg-purple-500 border-purple-400 shadow-[0_0_15px_rgba(168,85,247,1)] scale-125' : ''}`}></div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[500px]">
          ...
          >
            ...
            <div className="relative flex-1 flex items-center">
              ...
              >
                <div className="mb-6">
                  <span className="inline-block p-3 rounded-2xl bg-zinc-800/50 text-purple-400 mb-6">
            ...
            <div className="relative z-10 pt-6 border-t border-zinc-800/50 flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-lg font-bold text-white">
          ...
          <div className="lg:col-span-5 h-[300px] lg:h-full bg-zinc-950 rounded-[2.5rem] border border-zinc-800 p-8 md:p-12 flex flex-col justify-center relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-1 mb-6">
                ...
                <span className="text-4xl md:text-5xl font-bold text-purple-500">/5</span>
              </div>

              <div className="space-y-4">
                <div className="h-12 w-1 bg-purple-500 rounded-full mb-6" />
                ...
                <p className="text-zinc-500 leading-relaxed">
                  "We pride ourselves on creativity. From logo design to complete brand identities, our clients trust us to deliver exceptional visual solutions."
                </p>
              </div>
...
const ReadyToCreate = () => {
  return (
    <section className="py-40 px-6 bg-black relative overflow-hidden flex items-center justify-center">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.05)_0%,rgba(0,0,0,0)_70%)]"></div>
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center gap-2 mb-12 bg-zinc-900/80 border border-zinc-800 px-4 py-1 rounded-full">
            ...
            <span className="text-purple-500 font-mono text-xs tracking-widest">CREATIVE READY</span>
        </div>
        ...
        <div className="relative mb-12 group cursor-default">
            <h2 className="text-7xl md:text-9xl font-black text-white tracking-tighter uppercase relative z-10">
                Ready To<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-800">Create?</span>
            </h2>
        </div>

        <p className="text-zinc-400 text-xl mb-4">Stop blending in. Start standing out.</p>
        <p className="text-zinc-500 mb-12">We turn ideas into visual experiences.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    name="firstName"
                    required
                    className="w-full bg-zinc-900/30 border border-white/10 rounded-lg px-4 py-3 text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition-all hover:border-white/20"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <select
                  id="service"
                  name="service"
                  className="w-full bg-zinc-900/30 border border-white/10 rounded-lg px-4 py-3 text-zinc-100 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition-all hover:border-white/20"
                >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full bg-zinc-900/30 border border-white/10 rounded-lg px-4 py-3 text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition-all hover:border-white/20 resize-y min-h-[120px]"
                />
              </div>
              ...
              {/* Success Message */}
              {status === "success" && (
                <div className="bg-purple-500/10 border border-purple-500/20 text-purple-400 px-4 py-3 rounded-lg">
